...
check_file "SKILL.md"
check_file "references/jetson-display-stack-repair.md"
...
check_contains "SKILL.md" "Validation|验证"
...
check_contains "references/jetson-display-stack-repair.md" "gdm|display-manager|nvweston"

for cmd in systemctl loginctl rg; do

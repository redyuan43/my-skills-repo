...
description: Install or repair the Siyuan-branded Codex CLI from the user's redyuan43/codex GitHub release on a remote Linux/Jetson/AGX host over SSH, including release asset selection, local-download-plus-scp fallback, user-level wrapper creation, PATH verification, and optional Codex auth transfer.
---

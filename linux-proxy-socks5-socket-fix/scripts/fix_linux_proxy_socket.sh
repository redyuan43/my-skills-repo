...
Usage:
  ...
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} apply-shell [--port PORT]
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} apply-user [--port PORT]
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} apply-system [--port PORT]
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} print-exports [--port PORT]
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} print-envfile [--port PORT]
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} revert
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} revert-shell
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} revert-user
  bash linux-proxy-socks5-socket-fix/scripts/${SCRIPT_NAME} revert-system
EOF
}

...
check_file "SKILL.md"
check_file "scripts/jetson_gpu_fan_guard.sh"
check_file "scripts/install_jetson_gpu_fan_guard.sh"
...
check_contains "SKILL.md" "阈值|threshold"
check_contains "SKILL.md" "验证"
...
for cmd in nvfancontrol systemctl; do

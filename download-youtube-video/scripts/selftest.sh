...
check_file "SKILL.md"
check_file "scripts/download_youtube.py"
check_file "references/yt_dlp_presets.md"
check_file "references/failure_taxonomy.md"
check_file "eval/val/items.json"

bash -n "$ROOT/scripts/selftest.sh"
python3 -m py_compile "$ROOT/scripts/download_youtube.py"
...
check_contains "references/failure_taxonomy.md" "Cookie"

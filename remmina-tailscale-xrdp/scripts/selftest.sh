...
check_file "scripts/selftest.sh"

bash -n "$ROOT/scripts/selftest.sh"

check_contains "SKILL.md" "确认 Gate"
check_contains "SKILL.md" "AuthURL"
check_contains "SKILL.md" "references/runbook.md"
check_contains "references/runbook.md" "Tailscale"
check_contains "references/runbook.md" "BackendState=Running|TailscaleIPs"
check_contains "references/runbook.md" "xrdp"

for cmd in tailscale remmina ssh rg; do

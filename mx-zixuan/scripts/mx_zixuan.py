...
def main():
    ...
    if not args.command:
        ...
        print("  查询自选股: python3 scripts/mx_zixuan.py query", file=sys.stderr)
        print("  添加自选股: python3 scripts/mx_zixuan.py add 贵州茅台", file=sys.stderr)
        print("  删除自选股: python3 scripts/mx_zixuan.py delete 贵州茅台", file=sys.stderr)
        print("  自然语言: python3 scripts/mx_zixuan.py \"把贵州茅台加入自选\"", file=sys.stderr)

...
def main():
    ...
    parser.add_argument('--output-dir', dest='output_dir', help='输出目录，默认 ~/.mx/mx-xuangu/output')
    ...
    # Default output directory is fixed to ~/.mx/mx-xuangu/output
    default_output = Path.home() / ".mx/mx-xuangu/output"

...
# ========== 基础查询 ==========
# 查询当前账户资金
python3 scripts/mx_moni.py "我的资金"
...
python3 scripts/mx_moni.py "买入 600519 1700 100"

# 市价买入：市价买入 万科A 000002，1000 股
python3 scripts/mx_moni.py "市价买入 000002 1000"

# 限价卖出：卖出 贵州茅台 600519，价格 1750 元，100 股
python3 scripts/mx_moni.py "卖出 600519 1750 100"

# 市价卖出：市价卖出 万科A 000002，500 股
python3 scripts/mx_moni.py "市价卖出 000002 500"

# ========== 撤单操作 ==========
# 撤销指定委托单
python3 scripts/mx_moni.py "撤单 261030200000048829"

# 一键撤销当日所有未成交委托
python3 scripts/mx_moni.py "一键撤单"

# ========== 经验交流发帖 ==========
# 触发发帖（输入总结内容）
python3 scripts/mx_moni.py "发一下操作帖"

# 自动检测今日是否有操作，有操作则提示输入内容发帖
python3 scripts/mx_moni.py --auto-post
```
...
- 所有操作结果会同时保存 JSON 和 TXT 文件到 `~/.mx/mx-moni/output/` 目录
